...
from task4.game.field_manager import FieldManager, Snake
from typing import Union, List, Tuple, Set, Dict
from types import FunctionType

from task4.network import NetworkHandler, Subscriber
        ...
        for player_id, update_id in player_updates:
            ...
            match update_id:
                ...
                case FieldManager.UPDATE_DEATH:
                    ...
                    self._sendMessage2Player(message=roleChangeMessage, player=player)
